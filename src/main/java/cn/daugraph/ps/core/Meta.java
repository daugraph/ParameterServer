...
public class Meta {
    ...
    public Meta(int head, int appId, int customerId, int timestamp, int sender, int recver, boolean request,
                boolean push, boolean pull, boolean isSimpleApp, String body, List<DataType> dataTypes, Control control,
                int dataSize, int priority) {
        this.head = head;
        this.appId = appId;
    ...
    public String toString() {
        return "Meta{" + "head=" + head + ", appId=" + appId + ", customerId=" + customerId + ", timestamp=" + timestamp
                + ", sender=" + sender + ", recver=" + recver + ", request=" + request + ", push=" + push + ", pull="
                + pull + ", isSimpleApp=" + isSimpleApp + ", body='" + body + '\'' + ", dataTypes=" + dataTypes
                + ", control=" + control + ", dataSize=" + dataSize + ", priority=" + priority + '}';
    }
    ...
    public static class Builder {
        ...
        public Meta build() {
            return new Meta(head, appId, customerId, timestamp, sender, recver, request, push, pull, isSimpleApp, body,
                    dataTypes, control, dataSize, priority);
        }
    }
}
