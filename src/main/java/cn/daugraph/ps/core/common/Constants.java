...
public final class Constants {
    ...
    public static final Integer SERVER_GROUP = 2;
    public static final Integer WORKER_GROUP = 4;
    public static final Integer SERVER_WORKER_GROUP = 6;
    public static final Integer ALL_GROUP = 7;
}
